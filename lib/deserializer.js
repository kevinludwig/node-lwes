...
var deserializeDouble = exports.deserializeDouble = function(buffer, state) {
    var data = buffer.readDoubleLE(state.offset());
    state.incr(8);
    return data;
};

var deserializeFloat = exports.deserializeFloat = function(buffer, state) {
    var data = buffer.readFloatLE(state.offset());
    state.incr(4);
    return data;
};
...
var deserializeInt32 = exports.deserializeInt32 = function(buffer, state) {
    var data = buffer.readInt32LE(state.offset());
    state.incr(4);
    return data;
};
...
var deserializeStringArray = exports.deserializeStringArray = function(buffer, state, encoding) {
    var len = deserializeUInt16(buffer, state.offset());
    var data = [];
    for (var i = 0; i < len; i++) {
...
var deserializeUInt64Array = exports.deserializeInt64Array = function(buffer, state) {
